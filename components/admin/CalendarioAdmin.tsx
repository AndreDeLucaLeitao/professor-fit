...
export default function CalendarioAdmin({ agendamentosIniciais, segundaInicial }: Props) {
  ...
  // Mapa de chave "YYYY-MM-DD HH" → AgendamentoAdmin
                  ...
                  >
                    {agendamento ? (
                      ...
                      <Link
                        ...
                        className="flex w-full h-full items-center justify-center rounded text-[0.65rem] font-semibold text-muted-foreground/50 hover:bg-muted hover:text-muted-foreground border border-transparent hover:border-border transition-colors"
                      >
                        +
                      </Link>
                    ) : null}
